 ...
 */
public class SinglePlayerBowlingScoreboardImpl_Heinrich implements SinglePlayerBowlingScoreboard_Heinrich, AssignmentMetaData
{
...
//		assert (boxIndex != 2) || (!isSpare(frameNumber)) : "boxIndex = " + boxIndex + ", but there was a Spare! : frameNumber = " + frameNumber;
	...
	public boolean isGameOver() 
	{
		...
		if(rollCount==MAXIMUM_ROLLS|| getCurrentFrame()>9)
		{
			isGameOver=true;
		}
