...
//	private TicTacToeBoard b1;
	...
	public void test() 
	{
		...
		System.out.println("\nFinal Test:");
		b3.setMark(0,0);
		assertFalse(b3.isGameOver());
		assertNull(b3.getWinner());
		b3.setMark(1,1);
		assertFalse(b3.isGameOver());
		assertNull(b3.getWinner());
		b3.setMark(2,0);
		...
		assertNull(b3.getWinner());
		b3.setMark(1,2);
		assertTrue(b3.isGameOver());
		assertEquals(Mark.O, b3.getWinner());
		System.out.println("The winner of this game is : " + b3.getWinner());
